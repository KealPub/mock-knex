...
function mockClient(client) {
  ...
  client.constructor.prototype._query = client._query = function(connection, obj) {
    var unbildQuery = {
      single: this.builder._single,
      statements: this.builder._statements
    };

    return new Promise(function(resolver, rejecter) {
      tracker.queries.track(_.extend(obj, {unbildQuery: unbildQuery}), resolver);
    });
  };
...
function mockRunner(Runner) {
  ...
  var oldRun = Runner.prototype.run;

  Runner.prototype.run = function(){
    this.client.builder = this.builder;
